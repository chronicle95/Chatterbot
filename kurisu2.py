...
emotion = []	#* emotion table (. - neutral, ! - exclamaion, ? - question) ,array[string]
...
def showStats():
	print(''.ljust(5)+'words: '+str(len(words))+', phrases: '+str(len(phrases))+', ansbase: '+str(len(pairs)))
	print(''.ljust(5)+'greets: '+str(len(greetz))+', learning msgs: '+str(len(learnt)))
